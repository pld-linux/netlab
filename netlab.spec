...
Zestaw narzędzi Netlab został zaprojektowany aby dostarczyć główne
narzędzia potrzebne do symulacji teoretycznie dobrze wykonanych
algorytmów sieci neuronowych i związanych z nimi modeli do zastosowań
...
Pliki pomocy dla zestawu narzędzi Netlab.
